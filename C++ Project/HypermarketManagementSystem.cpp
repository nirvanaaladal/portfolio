...
fstream infile;//create fstream. Input/output stream class to operate on files.
...
int main(){
	...
	do{//start loop
		...
		case 2:
			...
			break; //end of case2
		case 3:
			itemsWhoseQuantityIsLessThanFive();//call method itemsWhoseQuantityIsLessThanFive
			break; //end of case3
		case 4:
			itemsWithLessPriceThanGivenPrice();//call method itemsWithLessPriceThanGivenPrice
			break; //end of case4
		case 5:
			expiredItems();//call method expiredItems
			break; //end of case5
		case 6:
			stockStatistics();//call method stockStatistics
			break; //end of case6
		case 7:
			...
			cin>>quantity;
			updateStockItems(itemno, quantity);//call method updateStockItems
			break;//end of case7
		case 8:
